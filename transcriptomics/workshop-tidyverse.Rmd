...
author:
  - name: Janani Ravi
    ...
    affiliation: DBMI, CU Anschutz, R-Ladies Aurora
    affiliation_url: https://github.com/rladies-aurora
    orcid_id: 0000-0001-7443-925X
  - name: Arjun Krishnan
    url: https://thekrishnanlab.org
    affiliation: DBMI, CU Anschutz
    affiliation_url: https://medschool.cuanschutz.edu/dbmi
...
Janani is a computational biologist, an Asst.
Professor in the departments of Biomedical Informatics, CU Anschutz In her group, they develop computational approaches to understand infectious disease biology.
Check out her [webpage](https://jravilab.github.io) for more info.
You can reach her [here](https://jravilab.github.io/#contact).

She's also the founder & co-organizer of the [R-Ladies Aurora](https://www.meetup.com/rladies-aurora/), [R-Ladies East Lansing](https://rladies-eastlansing.github.io), Women+ Data Science, and AsiaR.
They conduct R and data science related meetups & workshops regularly!
So, do check out our upcoming events on [Meetup](https://www.meetup.com/rladies-aurora/events/).

# Part 1: Getting Started w/ `readr`

You can access all relevant material pertaining to this workshop [here](https://github.com/rladies-aurora/202503-RIntro-DataWrangling-Transcriptomics).
Other related workshops & useful [cheatsheets](https://github.com/rladies-aurora/cheatsheets).

## Installation and set-up

### Install RStudio

*Running RStudio locally?* [**Download RStudio**](http://rstudio.com/download)

*Want to try the latest 'Preview' version of RStudio?* [**RStudio Preview version**]((https://www.rstudio.com/products/rstudio/download/preview/))

*Trouble with local installation?* Login & start using [**RStudio Cloud**](https://rstudio.cloud) right away!

*New to RStudio IDE?* Use Help [Page #1](https://www.rstudio.com/products/rstudio/#Desktop) & [Page #2](https://www.rstudio.com/products/rstudio/features/)

### Install R

*... if you haven't already!* The RStudio startup message should specify your current local version of R.
For *e.g.,* `R v4.1.2`
...
Explore the [RLEL workshops](https://github.com/rladies-eastlansing/meetup-presentations) for more examples and sample codes for Tidy Data and DataViz [*e.g.,* \>\> `presentations/20181105-workshop-tidydata` uses the `gapminder` & `USArrests` datasets].
...
[Cheatsheets \@RStudio](https://www.rstudio.com/resources/cheatsheets/) \| [Our cheatsheets repo](https://github.com/rladies-aurora/cheatsheets)
...
```{r kable, layout="l-body-outset", results="asis"}
library(knitr)
kable(head(gse69360))
```
...
gse69360 %>%
  select(Geneid, starts_with("AF")) %>%               # selecting only Counts columns
...
-   Email: [janani\@msu.edu](mailto:janani@msu.edu){.email} \| [arjun\@msu.edu](mailto:arjun@msu.edu){.email}
...
-   You can access all relevant material pertaining to this workshop [here](https://github.com/rladies-aurora/202503-RIntro-DataWrangling-Transcriptomics).
-   Other related [R-Ladies Aurora workshops](https://github.com/rladies-aurora) & useful [cheatsheets](https://github.com/rladies-aurora/cheatsheets).
